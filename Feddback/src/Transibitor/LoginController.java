...
public class LoginController {
    ...
    private void redirectToMainPage() {
        try {
            Parent mainPageRoot = FXMLLoader.load(getClass().getResource("/Transibitor/FXMLHomePage.fxml"));
    ...
    private void redirectToAdminPage() {
        try {
            Parent adminPageRoot = FXMLLoader.load(getClass().getResource("/Transibitor/FXMLDasboardAdmin.fxml"));
            Stage stage = (Stage) usernameField.getScene().getWindow();
    ...
    private void handleSignUp() {
        try {
            Parent signUpRoot = FXMLLoader.load(getClass().getResource("/Transibitor/FXMLSignup.fxml"));
            Stage stage = (Stage) usernameField.getScene().getWindow();
