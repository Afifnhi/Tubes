...
//                 s = s + c;
//             }
//              cetak = (ArrayList<dataFeedback>) xstream.fromXML(s);
//             f.close();
//         } catch (Exception e) {
//             System.err.println("An error occours: " + e.getMessage());
//         }
//         return cetak;
//     }

//     public void observ(){
//         ObservableList<dataFeedback> list = FXCollections.observableArrayList(
